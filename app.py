...
with tab2:
    if comparison_selection == "LC FeMn vs Mn Briquette":
        ...
        gc1, gc2 = st.columns([1.5, 2.5])
        sel_grade = gc1.selectbox("Select Target Steel Grade", list(grades_data.keys()), index=0, key="fesi_grade")
        limits = grades_data[sel_grade]
        ...
        if res.success:
            ...
            max_single_cost = max(Cost_Per_Si_FeSi_Solver, Cost_Per_Si_SiMetal_Solver)
            savings = max_single_cost - blended_cost
