...
with st.sidebar:
    ...
    if comparison_selection != "Not selected":
        ...
        mn_target_def = 0.40 if is_mc else 0.36
        ...
        Mn_Addition_Target = st.number_input("Mn Addition Target (%)", value=mn_target_def, step=0.01, min_value=0.01, max_value=2.00, format="%.2f")
...
P_Alloy_Target = (Active_Mn * 1000.0) / (P_Alloy1_Mn * P_Alloy1_Rec)

Alloy_Base = P_Alloy_Target
Alloy_Alt = (Active_Mn * 1000.0) / (P_Alloy2_Mn * P_Alloy2_Rec)
