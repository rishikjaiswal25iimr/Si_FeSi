...
║      app_silicon.py  |  v2.1  (Production-Audited)                         ║
╠══════════════════════════════════════════════════════════════════════════════╣
...
║                                                                              ║
║  AUDIT FIXES v2.1:                                                           ║
║  • FIX: Plotly add_vline() and add_vrect() replaced annotation parameters   ║
║         with separate add_annotation() calls to prevent Timestamp arithmetic║
║         crashes on Streamlit Cloud / Python 3.14.                           ║
║  • IMPROVE: All horizontal/vertical lines now immune to shapeannotation bugs║
╚══════════════════════════════════════════════════════════════════════════════╝
"""
