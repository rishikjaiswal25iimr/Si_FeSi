...
[data-testid="stMetricValue"] {
    font-size: 1.3rem !important; /* Shrink value size (default is ~1.8rem) */
}
[data-testid="stMetricLabel"] {
    font-size: 0.85rem !important; /* Shrink label size */
}
[data-testid="stMetricDelta"] {
    font-size: 0.8rem !important; /* Shrink delta text size */
}
</style>
